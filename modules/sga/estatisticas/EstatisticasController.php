...
class EstatisticasController extends ModuleController {
    ...
    public function __construct(App $app, Modulo $modulo) {
        ...
        $this->graficos = array(
            1 => new Grafico(_('Atenciones por Estatus'), 'pie', 'unidade,date-range'),
            2 => new Grafico(_('Atenciones por Servicio'), 'pie', 'unidade,date-range'),
            3 => new Grafico(_('Tiempo medio de Atenciones'), 'bar', 'unidade,date-range')
        );
        $this->relatorios = array(
            1 => new Relatorio(_('Servicios Disponibles - Global'), 'servicos_disponiveis_global'),
            2 => new Relatorio(_('Servicios Disponibles - Unidades'), 'servicos_disponiveis_unidades', 'unidade'),
            3 => new Relatorio(_('Servicios Codificados'), 'servicos_codificados', 'unidade,date-range'),
            4 => new Relatorio(_('Atenciones Concluidas'), 'atendimentos_concluidos', 'unidade,date-range'),
            5 => new Relatorio(_('Atenciones en todos los Estatus'), 'atendimentos_status', 'unidade,date-range'),
            6 => new Relatorio(_('Tiempos medios por Analista'), 'tempo_medio_atendentes', 'date-range'),
            7 => new Relatorio(_('División'), 'lotacoes', 'unidade'),
    ...
    private function tempo_medio_atendimentos($dataInicial, $dataFinal, $unidadeId = 0) {
        ...
        $dados = array();
        $tempos = array(
            'espera' => _('Tiempo de Espera'),
            'deslocamento' => _('Tiempo de Desplazamiento'),
            'atendimento' => _('Tiempo de Atención'),
            'total' => _('Tiempo Total')
        );
        $dql = "
            SELECT 
