 ...
 */
class Grupo extends \Novosga\Model\Grupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'nome', 'descricao', 'unidade', 'left', 'right', 'level', 'parent', 'id');
        }
