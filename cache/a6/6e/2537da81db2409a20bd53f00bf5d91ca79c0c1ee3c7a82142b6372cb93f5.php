...
/* index.html.twig */
class __TwigTemplate_a66e2537da81db2409a20bd53f00bf5d91ca79c0c1ee3c7a82142b6372cb93f5 extends Twig_Template
{
...
";
    ...
    <div class=\"modal-dialog\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["prioridade"]) {
            // line 164
            echo "                        <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["prioridade"]) ? $context["prioridade"] : null), "id"), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["prioridade"]) ? $context["prioridade"] : null), "nome"), "html", null, true);
            echo "</option>
                        ";
        }
        $_parent = $context['_parent'];
